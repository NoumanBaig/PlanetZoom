...
public class QRHisData {
    ...
    @SerializedName("sraa_qr_code_name")
    @Expose
    private String sraaQrCodeName;
    @SerializedName("sraa_qr_code_cat")
    @Expose
    private String sraaQrCodeCat;
    @SerializedName("sraa_qr_code_sub_cat")
    @Expose
    private String sraaQrCodeSubCat;
    ...
    public String getSraaQrCodeName() {
        return sraaQrCodeName;
    }

    public void setSraaQrCodeName(String sraaQrCodeName) {
        this.sraaQrCodeName = sraaQrCodeName;
    }

    public String getSraaQrCodeCat() {
        return sraaQrCodeCat;
    }

    public void setSraaQrCodeCat(String sraaQrCodeCat) {
        this.sraaQrCodeCat = sraaQrCodeCat;
    }

    public String getSraaQrCodeSubCat() {
        return sraaQrCodeSubCat;
    }

    public void setSraaQrCodeSubCat(String sraaQrCodeSubCat) {
        this.sraaQrCodeSubCat = sraaQrCodeSubCat;
    }
