 ...
 */
package com.angadi.tripmanagementa.circlenavigation;
...
//    }
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            spaceItemIconSize = typedArray.getDimensionPixelSize(R.styleable.CircleNavigationView_space_item_icon_size, resources.getDimensionPixelSize(R.dimen.space_item_icon_default_size));
            spaceItemIconOnlySize = typedArray.getDimensionPixelSize(R.styleable.CircleNavigationView_space_item_icon_only_size, resources.getDimensionPixelSize(R.dimen.space_item_icon_only_size));
            spaceItemTextSize = typedArray.getDimensionPixelSize(R.styleable.CircleNavigationView_space_item_text_size, resources.getDimensionPixelSize(R.dimen.space_item_text_default_size));
            spaceItemIconOnlySize = typedArray.getDimensionPixelSize(R.styleable.CircleNavigationView_space_item_icon_only_size, resources.getDimensionPixelSize(R.dimen.space_item_icon_only_size));
            spaceBackgroundColor = typedArray.getColor(R.styleable.CircleNavigationView_space_background_color, resources.getColor(R.color.space_default_color));
            centreButtonColor = typedArray.getColor(R.styleable.CircleNavigationView_inactive_center_button_background_color, resources.getColor(R.color.centre_button_color));
            activeSpaceItemColor = typedArray.getColor(R.styleable.CircleNavigationView_active_item_color, resources.getColor(R.color.space_white));
            inActiveSpaceItemColor = typedArray.getColor(R.styleable.CircleNavigationView_inactive_item_color, resources.getColor(R.color.default_inactive_item_color));
            ...
            inActiveCentreButtonIconColor = typedArray.getColor(R.styleable.CircleNavigationView_inactive_center_button_icon_color, resources.getColor(R.color.default_inactive_item_color));
            activeCentreButtonBackgroundColor = typedArray.getColor(R.styleable.CircleNavigationView_active_center_button_background_color, resources.getColor(R.color.centre_button_color));
