...
public class DashboardDialogAdapter extends RecyclerView.Adapter<DashboardDialogAdapter.MyViewHolder> {

    Context mContext;
    List<EventVisitorResult> resultList;
    ClickListener clickListener;

    public DashboardDialogAdapter(Context context, List<EventVisitorResult> resultList) {
        super();
      ...
      holder.layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (clickListener != null) {
                    clickListener.onClick(view, position,resultList.get(position).getLoginId());
                }
            }
        });

//      holder.txt_date.setText("Date: "+resultList.get(position).getMtaaDate());
      holder.txt_name.setText("Name: "+resultList.get(position).getFname());
//      holder.txt_scName.setText("Scanner Name: "+resultList.get(position).getMtaaVolunteerName());
      holder.txt_loginId.setText("Login ID: "+resultList.get(position).getLoginId());
