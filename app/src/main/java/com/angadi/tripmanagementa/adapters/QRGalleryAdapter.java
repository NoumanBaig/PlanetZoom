...
public class QRGalleryAdapter extends RecyclerView.Adapter<QRGalleryAdapter.MyViewHolder> {

    Context mContext;
    String string;
    ClickListener clickListener;
    DeleteListener deleteListener;
    List<QRCodeGallery> galleryList;

    public QRGalleryAdapter(Context context, List<QRCodeGallery> galleryList, String string) {
        super();
        ...
        holder.img_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (deleteListener != null) {
                    deleteListener.onDelete(view, position, galleryList.get(position).getQiaaId());
                }
            }
        });

        holder.imageView.setImageURI(Constants.BASE_URL + galleryList.get(position).getQiaaImage());
